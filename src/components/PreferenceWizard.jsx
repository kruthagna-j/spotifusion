  ...
  return <div className="sf-onboarding-page px-3 py-4 sm:px-6">
    <div className="sf-onboarding-card w-full max-w-3xl max-h-[calc(100vh-2rem)] overflow-y-auto">
      ...
      {step === 2 && <section>
        ...
        <p className="text-sm text-text-muted mb-4">Pick as many as you like. Spotifusion will use these artists and your selected languages to build recommendations on Home.</p>
        <div className="flex items-center gap-2 text-brand text-xs font-bold mb-3"><Sparkles size={15}/> Suggested for {languages.join(', ')}</div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-[48vh] overflow-y-auto pr-1">
