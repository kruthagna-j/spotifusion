...
export default function QueuePanel({ onClose }) {
  ...
  return (
    <div className="absolute bottom-full right-0 mb-2 w-80 max-h-[70vh] flex flex-col bg-surface-elevated rounded-lg shadow-2xl border border-border z-40 overflow-hidden">
