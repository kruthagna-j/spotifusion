      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden md:flex items-center gap-1">
          <button
            onClick={() => navigate(-1)}
            aria-label="Go back"
            className="w-8 h-8 rounded-full bg-surface-elevated flex items-center justify-center hover:bg-surface-hover transition-colors"
          >
            <ChevronLeft size={20} />
          </button>
          <button
        ...
        <nav className="hidden md:flex items-center gap-6" aria-label="Main navigation">
          ...
          <NavLink to="/local-files" className={navLinkClass}>
            Local Files
          </NavLink>
        </nav>
        ...
        {location.pathname !== '/search' && (
          <button
            ...
            className="flex items-center gap-2 bg-surface-elevated hover:bg-surface-hover rounded-full pl-3 pr-4 py-2 text-sm text-text-muted md:hidden"
          >
