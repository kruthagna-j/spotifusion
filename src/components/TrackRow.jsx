...
function TrackRow({track,index,contextTracks}){
 ...
 return <div onDoubleClick={()=>player.playTrack(track,contextTracks)} className={`group grid grid-cols-[24px_1fr_auto] items-center gap-4 px-4 py-2 rounded-md hover:bg-surface-hover ${isCurrent?'text-brand':'text-text-muted'}`}>
